...
amqp_parameters = pika.ConnectionParameters('134.169.115.45', 5672, '/', amqp_credentials)
...
MQTT_TOPIC = "notelab/dhtsensor/temperatureAndHumidity"
...
def on_message(client, userdata, msg):
    ...
    print ("MQTT topic is: " + msg.topic + ", and message received from MQTT broker: " + json.dumps(mqttMessage))
